...
- Stations by category
  - Are the major stations busiest?
  - Average stops per type
...
- Where they most often occur (routes/stations)
- Reasons
  - Most/least frequent
  - Relationship between reasons and length of disruptions
- Longest shortest/disruptions
