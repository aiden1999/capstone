...
def test_explode_row_works():
    ...
    pl.testing.assert_frame_equal(returned_df, expected_df)
...
def test_keep_columns_works():
    ...
    pl.testing.assert_frame_equal(test_df, expected_df)
...
def test_count_services_works():
    ...
    pl.testing.assert_frame_equal(expected_df, test_df)
